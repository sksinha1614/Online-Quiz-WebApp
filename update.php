...
$desc = $_POST['desc'];
$id=uniqid();
$q3=mysqli_query($con,"INSERT INTO quiz VALUES  ('$id','$name' ,'$class', '$sahi' , '$wrong','$total','$time' ,'$desc','$tag', NOW())");
...
// if(!isset($_SESSION['answer_choice'])){

//     $_SESSION['answer_choice'] = array();
//     array_push($_SESSION['answer_choice'],$_POST['ans']);
